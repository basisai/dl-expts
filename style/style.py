"""
Script to perform style transform.
"""
import os
import time
...
style_reference_image_path = os.getenv("style_reference_image_path")
result_prefix = os.getenv("result_prefix")
iterations = int(os.getenv("iterations", 10))
content_weight = float(os.getenv("content_weight", 0.025))
style_weight = float(os.getenv("style_weight", 1.0))
total_variation_weight = float(os.getenv("total_variation_weight", 1.0))
